...
#include "ui_Euro2DollarCalculator.h"
#include "euro_to_dollar_view.h"
#include "euro_to_dollar_presenter.h"

class Euro2DollarCalculator : public QMainWindow, public euro_to_dollar_view
{
    Q_OBJECT
...
public:
    Euro2DollarCalculator(QWidget *parent = Q_NULLPTR);
...
private:
    Ui::Euro2DollarCalculatorClass ui;
